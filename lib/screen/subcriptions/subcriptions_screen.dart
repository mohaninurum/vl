                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const Text("All answers, no ads", textAlign: TextAlign.center, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                                SizedBox(height: size.height * 0.019),
                                const Text("Expert explanations for every topic", textAlign: TextAlign.center, style: TextStyle(fontSize: 14, color: Colors.black54)),
                                SizedBox(height: size.height * 0.025),
                                Text("\$100.99", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: selected ? Colors.green : Colors.black)),
                                SizedBox(height: size.height * 0.017),
                                const Text("Billed every year", style: TextStyle(fontSize: 14, color: Colors.black54)),
                                const Text("12 months at \$8.00/month", style: TextStyle(fontSize: 13, color: Colors.black45)),
                                SizedBox(height: size.height * 0.01),
                                Container(width: double.infinity, height: size.height * 0.032, decoration: BoxDecoration(color: selected ? Colors.green : Colors.blueGrey, borderRadius: BorderRadius.circular(20)), child: MaterialButton(onPressed: () {}, child: Text("Get", style: TextStyle(color: selected ? Colors.white : Colors.white, fontSize: 16)))),
                              ],
                            ),
                          ),
                        );
