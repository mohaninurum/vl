          ...
          return state.categoryResponseModel.categories.isNotEmpty
              ? GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return CategoryItem(comingSoon: item.categoryName == "Important Questions" ? true : false, language: language, title: item.categoryName, image: item.categoryIcon, onTap: () => context.read<CategorySelectedBloc>().add(CategorySelected(category: item.categoryName, id: item.categoryId.toString())));
                },
              )
