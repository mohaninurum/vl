...
class QuizScreen extends StatefulWidget {
  ...
  const QuizScreen({super.key, this.selectClassesName, this.selectChapterName, this.language, this.tabtype});
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  void initState() {
    super.initState();
    context.read<QuizBloc>().add(IsLoadingQuiz());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBarWidget(appTitle: '${widget.selectClassesName.substring(0, indexget + 1)} ${widget.tabtype}'),
