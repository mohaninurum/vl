...
import '../block/all_content_state.dart';
...
class AllContentListWidges extends StatelessWidget {
  ...
  AllContentListWidges({super.key, required this.language, required this.selectClassName, required this.selectChaptorName});
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ChapterItemCard(
                        ...
                        onTap: () {
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => VideoContentDetailScreen(videoUrl: "https://www.youtube.com/watch?v=nqye02H_H6I", language: gradeLang, selectChapterName: selectChaptorName, selectClassName: selectClassName, selectTopicName: item.title)));
                        },
                      );
                    },
                  ),
