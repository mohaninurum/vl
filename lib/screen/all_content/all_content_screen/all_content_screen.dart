...
class AllContentScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: Scaffold(appBar: AppBarWidget(), backgroundColor: const Color(0xFFF2F5FA), body: SafeArea(child: Padding(padding: EdgeInsets.symmetric(horizontal: 16), child: AllContentWidget(id: id, language: language, selectClassesName: selectClassName, selectChapterName: selectChapterName)))));
  }
}
