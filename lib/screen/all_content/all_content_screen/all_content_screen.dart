...
class AllContentScreen extends StatelessWidget {
  AllContentScreen({required this.language, required this.selectClassName, required this.selectChapterName, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(appBar: AppBarWidget(), backgroundColor: const Color(0xFFF2F5FA), body: SafeArea(child: Padding(padding: EdgeInsets.symmetric(horizontal: media.width * 0.04), child: AllContentWidget(language: language, selectClassesName: selectClassName, selectChapterName: selectChapterName))));
  }
}
